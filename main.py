...
git_user_name = "BohdanDev811"
git_user_email = "WonderDev0129@outlook.com"
...
commit_frequency_min = 5  # minimum commits per day
commit_frequency_max = 12  # maximum commits per day
